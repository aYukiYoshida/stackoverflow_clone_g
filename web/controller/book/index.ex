...
defmodule StackoverflowCloneG.Controller.Book.IndexRequestParams do
...
defmodule StackoverflowCloneG.Controller.Book.Index do
  ...
  alias StackoverflowCloneG.Controller.Book.{Helper, IndexRequestParams}
