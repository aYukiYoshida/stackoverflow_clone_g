defmodule StackoverflowCloneG.Controller.Book.IndexTest do
  use StackoverflowCloneG.CommonCase
  alias Dodai.RetrieveDedicatedDataEntityListRequestQuery, as: Query
  alias Sazabi.G2gClient
  alias StackoverflowCloneG.Controller.Book.Index
  alias StackoverflowCloneG.Controller.Book.IndexRequestParams
  alias StackoverflowCloneG.TestData.BookData
